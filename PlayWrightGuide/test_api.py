...
# Initialize
GITHUB_API_TOKEN = "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"
assert GITHUB_API_TOKEN, "GITHUB_API_TOKEN is not set"

GITHUB_USER = "martinyanev94"
...
def create_test_repo(
    ...
    new_repo = api_request_context.post("/user/repos",
                                        data={"name": GITHUB_REPO})
    assert new_repo.ok

    yield

    # delete_repo = api_request_context.delete(
